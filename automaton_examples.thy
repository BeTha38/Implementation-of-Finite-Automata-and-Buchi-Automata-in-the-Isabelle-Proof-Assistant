...
definition pow2_prefixes :: "nat language" where "pow2_prefixes = {pre_omega_word (omega_word_pow2_ab 1 0) n | n . True}"
...
proof(rule ccontr)
  ...
  hence word_in: "word \<in> pow2_prefixes" unfolding pow2_prefixes_def by blast
  ...
  then obtain M where M: "u @ w = pre_omega_word (omega_word_pow2_ab 1 0) M" unfolding pow2_prefixes_def by blast
