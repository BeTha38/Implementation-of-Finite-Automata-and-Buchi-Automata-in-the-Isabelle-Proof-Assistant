...
lemma inheritance_alternation_well_def_r:
...
lemma inheritance_alternation_well_def_l:
  assumes "RE_well_defined (Alternation r1 r2) \<Sigma>"
  shows "RE_well_defined r1 \<Sigma> \<and> RE_well_defined r2 \<Sigma>"
  using assms unfolding RE_well_defined_def by simp

proposition inheritance_alternation_well_def: "RE_well_defined (Alternation r1 r2) \<Sigma> \<longleftrightarrow> RE_well_defined r1 \<Sigma> \<and> RE_well_defined r2 \<Sigma>"
  using inheritance_alternation_well_def_r inheritance_alternation_well_def_l by blast

lemma inheritance_concatenation_well_def_r:
  assumes "RE_well_defined r1 \<Sigma>" "RE_well_defined r2 \<Sigma>"
  shows "RE_well_defined (Concatenation r1 r2) \<Sigma>"
  using assms unfolding RE_well_defined_def by simp

lemma inheritance_concatenation_well_def_l:
  assumes "RE_well_defined (Concatenation r1 r2) \<Sigma>"
  shows "RE_well_defined r1 \<Sigma> \<and> RE_well_defined r2 \<Sigma>"
  using assms unfolding RE_well_defined_def by simp

proposition inheritance_concatenation_well_def: "RE_well_defined (Concatenation r1 r2) \<Sigma> \<longleftrightarrow> RE_well_defined r1 \<Sigma> \<and> RE_well_defined r2 \<Sigma>"
  using inheritance_concatenation_well_def_r inheritance_concatenation_well_def_l by fast

lemma inheritance_kleene_star_well_def_r:
  assumes "RE_well_defined r \<Sigma>"
  shows "RE_well_defined (Kleene_star r) \<Sigma>"
  using assms unfolding RE_well_defined_def by simp

lemma inheritance_kleene_star_well_def_l:
  assumes "RE_well_defined (Kleene_star r) \<Sigma>"
  shows "RE_well_defined r \<Sigma>"
  using assms unfolding RE_well_defined_def by simp

proposition inheritance_kleene_star_well_def: "RE_well_defined (Kleene_star r) \<Sigma> \<longleftrightarrow> RE_well_defined r \<Sigma>"
  using inheritance_kleene_star_well_def_r inheritance_kleene_star_well_def_l by blast
